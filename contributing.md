...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the ecc unit tests or QA tests
...
Patches that change ecc consensus rules are considerably more involved than
...
Where a patch set proposes to change the ecc consensus, it must have been
