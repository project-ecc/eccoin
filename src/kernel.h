...
static uint64_t cp1 = 16777702570188849269;
static uint64_t cp2 = 7733137255225840690;
static uint64_t cp3 = 12347469112240434862;
static uint64_t cp4 = 13012520772513449195;

static std::map<unsigned int, uint64_t> mapModifierCheckpoints =
    boost::assign::map_list_of
        (  389423, cp1)
        ( 1241591, cp2)
        ( 1241829, cp3)
