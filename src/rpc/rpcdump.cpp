...
UniValue importprivkey(const UniValue& params, bool fHelp)
{
    ...
    CKeyID vchAddress = pubkey.GetID();
    {
        ...
        if (fRescan) {
            pwalletMain->ScanForWalletTransactions(pchainMain->chainActive.Genesis(), true);
        }
    }
...
UniValue importwallet(const UniValue& params, bool fHelp)
{
    ...
    int64_t nTimeBegin = pchainMain->chainActive.Tip()->GetBlockTime();
    ...
    CBlockIndex *pindex = pchainMain->chainActive.Tip();
    ...
    LogPrintf("Rescanning last %i blocks\n", pchainMain->chainActive.Height() - pindex->nHeight + 1);
...
UniValue dumpwallet(const UniValue& params, bool fHelp)
{
    ...
    file << strprintf("# * Best block at time of backup was %i (%s),\n", pchainMain->chainActive.Height(), pchainMain->chainActive.Tip()->GetBlockHash().ToString());
    file << strprintf("#   mined on %s\n", EncodeDumpTime(pchainMain->chainActive.Tip()->GetBlockTime()));
    file << "\n";
