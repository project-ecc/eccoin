...
BOOST_AUTO_TEST_CASE(MempoolIndexingTest)
{
    ...
    std::string dummy;
    CTransaction tx10 = CTransaction();
    CTransaction tx9 = CTransaction();
    CTransaction tx8 = CTransaction();
